...
const About = () => (
  <div className="about-container">
    ...
    <div className="self-description-container">
      ...
      <div className="paragraph">
      In my research, I develop new devices and systems that interact with programmable structures and materials. For example, I use <a href="https://hcie.csail.mit.edu/research/lenticularobject/lenticular-object.html" target="_blank">lenticular structure</a> and photochromic material to achieve programmable surface textures on 3D objects. 
      </div>
