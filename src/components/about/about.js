  ...
  <div className="about-container">
    ...
    <div className="self-description-container">
      ...
      <div className="paragraph">
        ...
        My research explores fabrication methods for objects with dynamic appearances, including using compliant structures, optic structures and programmable materials. 
